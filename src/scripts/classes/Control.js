...
export class Control extends Canvas {
	...
	init() {
		...
		this.canvas.onclick = e => this.clickEvent.call(this, e)
	...
	drawMouse() {
		...
		if (this.mousePos == `${x} ${y}`) return
		this.mousePos = `${x} ${y}`
		this.mousePosEl.innerText = this.mousePos
	}
}

Control.prototype.wheelEvent = function(e) {
	e.preventDefault()
...
Control.prototype.downEvent = function(e) {
	this.mouseDownPos = {x: e.clientX, y: e.clientY}
	this.pointerDown = true
}
Control.prototype.upEvent = function(e) {
	this.pointerDown = false
	this.el.style.cursor = "default"
}
Control.prototype.moveEvent = function(e) {
	e.preventDefault()
...
Control.prototype.pinchEvent = function(e) {
...
Control.prototype.pinchEndEvent = function(e) {
	this.pinchLen = null
	this.isZoom = false
}

Control.prototype.clickEvent = function(e) {
	if (!this.mouse.target) return
	this.info.show(this.mouse.target)
}